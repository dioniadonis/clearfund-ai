            ...
            <Card className="max-w-2xl mx-auto border-none shadow-2xl bg-white/90 backdrop-blur-sm">
              <CardContent className="p-8 md:p-12">
                ...
                <div className="text-center space-y-4">
                  <p className="text-gray-700">Ready now? Apply online or call our concierge.</p>
                  <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    <a href="/apply?cta=blog_apply" className="inline-flex items-center justify-center rounded-md bg-clearfund-blue px-6 py-3 font-semibold text-white hover:bg-clearfund-dark-blue">Apply online</a>
                    <a href="tel:8665784721" className="inline-flex items-center justify-center rounded-md border border-clearfund-blue px-6 py-3 font-semibold text-clearfund-blue">Call 866-578-4721</a>
                  </div>
                </div>
